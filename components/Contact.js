...
import { Shield, Award, Calendar, MailOpen, PhoneCall, MapPin, UserCircle2, Check } from 'lucide-react';
...
const CopyableEmail = ({ email }) => {
  ...
  return (
    <button
      onClick={handleCopy}
      className="flex items-center space-x-2 text-lg font-semibold text-gray-600 hover:text-gray-800 transition duration-150 cursor-pointer group"
    >
      <MailOpen className="group-hover:scale-110 transition-transform" />
      <span className="underline decoration-dashed hover:decoration-solid">{email}</span>
      {copied && (
      ...
      <div className="flex flex-col sm:flex-row sm:items-start sm:space-x-6 space-y-4 sm:space-y-0">
        <div className="flex flex-col space-y-1">
          ...
          <div className="flex items-center space-x-2">
            ...
            <span className="font-medium text-lg">Salman Qureshi</span>
          </div>
        </div>
        ...
        <div className="flex flex-col space-y-1">
          ...
          <div className="flex items-center space-x-2">
            <UserCircle2 className="w-5 h-5" />
            <span className="font-medium text-lg">Shakeel Qureshi</span>
          </div>
        </div>
      </div>

      <CopyableEmail email="bharatenamel@gmail.com" />
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 pt-20">
     ...
     <div className="text-center mt-10 mb-20 px-4">
        <h3 className="text-lg text-gray-600 mb-2">Invite Us to Tender</h3>
